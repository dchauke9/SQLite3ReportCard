...
import com.example.ekasilabalexcdtb.sqlite3reportcard.DatabaseHelper.BaseActivity;
...
public class MainActivity extends BaseActivity implements GoogleApiClient.OnConnectionFailedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        USER_NAME = (EditText) findViewById(R.id.TFUsername);
        USER_PASS = (EditText) findViewById(R.id.TFPassword);
            ...
            public void onClick(View v) {
               ...
               // status = bundle.getInt("Status");
                   ...
                   password = USER_PASS.getText().toString();
                    ...
                    Cursor cursor = dbHelper.getInformation(dbHelper);
                    cursor.moveToFirst();
                    ...
                    if (loginStatus) {
                        ...
                        Intent intent = new Intent(MainActivity.this, AppRegActivity.class);
